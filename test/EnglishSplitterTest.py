...
class EnglishSplitterTest(unittest.TestCase):
    ...
    def test_Split(self):
        self.assertEqual(11, len(self.splitter.split("Firstly ,I like travelling to see new places. Such as museums ,restaurant\n" +
